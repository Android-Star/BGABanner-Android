...
public class BGABanner extends ConstraintLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initView(Context context) {
        ...
        mBannerConstraintSet.connect(R.id.banner_pointContainerId, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START);
        mBannerConstraintSet.connect(R.id.banner_pointContainerId, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END);
        ...
        if (mIsNumberIndicator) {
            ...
            if (isIndicatorAlignTop) {
                mBannerConstraintSet.connect(R.id.banner_indicatorId, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP,
                        mNumberIndicatorTopBottomMargin);
            } else {
                mBannerConstraintSet.connect(R.id.banner_indicatorId, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM,
                        mNumberIndicatorTopBottomMargin);
            }
        ...
        if (horizontalGravity == Gravity.LEFT) {
            mBannerConstraintSet.connect(R.id.banner_indicatorId, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START,
            ...
            mBannerConstraintSet.connect(R.id.banner_tipId, ConstraintSet.START, R.id.banner_indicatorId, ConstraintSet.END,
                    mIndicatorContainerLeftRightPadding);
            mBannerConstraintSet.connect(R.id.banner_tipId, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, mIndicatorContainerLeftRightPadding);

            mTipTv.setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
        } else if (horizontalGravity == Gravity.RIGHT) {
            mBannerConstraintSet.connect(R.id.banner_indicatorId, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END,
                    mIndicatorContainerLeftRightPadding);
            mBannerConstraintSet.connect(R.id.banner_tipId, ConstraintSet.END, R.id.banner_indicatorId, ConstraintSet.START,
                    mIndicatorContainerLeftRightPadding);
            mBannerConstraintSet.connect(R.id.banner_tipId, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START,
                    mIndicatorContainerLeftRightPadding);
        } else {
